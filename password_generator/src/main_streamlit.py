...
with st.sidebar:
  st.image("../image/mehdi_logo.png", width=200)
...
if your_selection == "Random Password":
  ...
  your_name = st.text_input(label="Your Name (any strings is acceptable!)", value=" ")
  ...
  if your_selection:
    if option ==  "Include Numbers" and your_name != " ":
      ...
      st.write(outcome)
      st.write("You may select and copy your password.")
